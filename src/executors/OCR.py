"""
Qwen OpenRouter Executor: OCR (Text Recognition)
"""
...
from capsules.QwenOpenRouter.src.utils.response import build_response_ocr
        ...
        return [
            {
                "role": "system",
                "content": (
                    "You act as an OCR model. Your task is to read text from the image and return it in "
                    "paragraphs representing the structure of texts in the image. "
                    "You should only return recognised text, nothing else."
                ),
            },
            {
                "role": "user",
