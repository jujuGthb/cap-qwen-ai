"""
Qwen OpenRouter Executor: Detailed Caption
"""
...
from capsules.QwenOpenRouter.src.utils.response import build_response_detailed_caption
        ...
        return [
            {
                ...
                "content": (
                    ...
                    "Your task is to provide a detailed, extensive description of the image. "
                    "Cover objects, colors, spatial relationships, and overall scene context. "
